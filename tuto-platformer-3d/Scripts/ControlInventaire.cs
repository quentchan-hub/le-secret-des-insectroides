...
public partial class ControlInventaire : Control
{
	...
	public override void _Process(double delta)
	{
		...
		if (GameStateScript.aLaCle && !item2.Visible)
		{
		...
		if (GameStateScript.aLaCleRose && !item3.Visible)
		{
		...
		if (GameStateScript.aLaBomba & !item4.Visible)
		{
		...
		if(GameStateScript.aLeRessort & !item5.Visible)
		{
			toucheItem5.Visible = true;
			fondItem5.SelfModulate = new Color(1, 1, 1, 0.3f);
			item5.Visible = true;
		}
		
		if (GameStateScript.aLeFouet & !item1.Visible)
		{
			toucheItem1.Visible = true;
			fondItem1.SelfModulate = new Color(1, 1, 1, 0.3f);
			item1.Visible = true;
		}
	}
}
